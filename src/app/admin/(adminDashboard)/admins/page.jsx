...
import { deleteAdmin, getAllUsers, getUserSession } from "@/serverActions/auth";
import { Pencil, Plus, Trash2, User2 } from "lucide-react";
  ...
  return (
    <>
      <div className="p-8 max-w-7xl">
        <div className="mb-6">
          <h1 className="text-3xl font-semibold mb-2">Admins</h1>
          <p className="text-gray-600">Manage your Admins</p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          {data.length === 0 ? (
            <div className="text-center py-16 text-gray-500">
              <User2 className="size-12 mx-auto mb-4 text-gray-400" />
              <p className="mb-4">No Admins added yet</p>
              <Link
            ...
            <div className="border rounded-lg overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50 border-b">
                  <tr>
                    <th className="px-4 py-3 text-left text-sm font-medium text-gray-700 w-[90px]">
                      S. No.
                    </th>
                    ...
                    <tr key={user._id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-right">
                        <div className="flex justify-end gap-1">
                          <Link
                            href={`/admin/admins/edit?slug=${user._id}`}
      ...
      {query.delete === "true" && (
        <DeleteModal id={query.id} fn={deleteAdmin} />
      )}
    </>
  );
};
